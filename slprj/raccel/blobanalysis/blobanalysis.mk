...
MODEL                = blobanalysis
MODULES              = rt_logging.c blobanalysis.c blobanalysis_capi.c blobanalysis_data.c blobanalysis_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT              = blobanalysis.exe
MAKEFILE             = blobanalysis.mk
...
START_DIR            = C:/Users/chira/MATLAB~1/matRad
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = blobanalysis_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/blobanalysis \
