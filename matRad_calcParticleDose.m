...
%                   if calcRBE
%                      bixelRBEMcMahon = McMahonModel(bixelLET);
%                      bixelRBEManchester = ManchesterModel(bixelLET,bixelDose);
%                   
%                      RBEDoseTmpContainerMcMahon{mod(counter-1,numOfBixelsContainer)+1,1} = sparse(VdoseGrid(ix(currIx)),1,bixelRBEMcMahon.*bixelDose,dij.doseGrid.numOfVoxels,1);
%                      RBEDoseTmpContainerManchester{mod(counter-1,numOfBixelsContainer)+1,1} = sparse(VdoseGrid(ix(currIx)),1,bixelRBEManchester.*bixelDose,dij.doseGrid.numOfVoxels,1);
%                   end
