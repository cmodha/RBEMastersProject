        ...
        for i = 1:size(DispInfo,1)
            ...
            if isstruct(Result.(DispInfo{i,1})) || isvector(Result.(DispInfo{i,1}))
                ...
                elseif strfind(DispInfo{i,1},'LET')
                    DispInfo{i,3} = '[keV/um]';
                elseif strfind(DispInfo{i,1},'RBEMcMahon')
                    DispInfo{i,3} = '[1]';
                elseif strfind(DispInfo{i,1},'overdosingMcMahon')
                    DispInfo{i,3} = '[Gy]';
                elseif strfind(DispInfo{i,1},'overdosingMcNamara')
                    DispInfo{i,3} = '[Gy]';
                elseif strfind(DispInfo{i,1},'cellDeathMcMahonNoRegen')
                    DispInfo{i,3} = '[1]';
                elseif strfind(DispInfo{i,1},'cellSurvivalMcMahonNoRegen')
                    DispInfo{i,3} = '[1]';
                elseif strfind(DispInfo{i,1},'cellSurvivalNoRegen')
                    DispInfo{i,3} = '[1]';            
                elseif strfind(DispInfo{i,1},'cellDeathNoRegen')
                    DispInfo{i,3} = '[1]';
                elseif strfind(DispInfo{i,1},'extraCellDeathMcMahon')
                    DispInfo{i,3} = '[1]';
                elseif strfind(DispInfo{i,1},'extraCellDeathMcNamara')
                    DispInfo{i,3} = '[1]';
                elseif strfind(DispInfo{i,1},'RBEMcNamara')
                    DispInfo{i,3} = '[1]';
                elseif strfind(DispInfo{i,1},'cellDeath')
                    DispInfo{i,3} = '[1]';
